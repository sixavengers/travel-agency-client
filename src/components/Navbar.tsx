...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
            ...
            <div className='flex justify-between items-center border border-gray-600 p-2 rounded'>
                <BiSearch className='pr-2' size={25} />
                <input style={{outline:"none"}} type="text" name="" id="" placeholder='Seasch your Destination...' />
            </div>
