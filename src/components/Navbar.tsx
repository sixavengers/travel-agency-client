...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 w-full px-4 absolute z-10 nav-area'>
            ...
            <ul className={nav ? 'fixed left-3 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
            <img className='logo' src={LOGO} alt="" />
