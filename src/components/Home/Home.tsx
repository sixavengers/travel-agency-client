      ...
      <div className="full-area">
        ...
        <div className="w-full min-h-screen grid place-items-center font-poppins">
          ...
          <div className="lg:container z-40 mx-auto px-5 2xl:px-0 ">
            <div className="md:flex items-center justify-between 2xl:gap-80  flex-col md:flex-row md:gap-x-8 md:gap-y-12 gap-14">
              <div className="left-content flex-1 2xl:flex-1 md:mt-6  mt-25 mx-auto sm:pr-8">
              ...
              <div className="right-content flex-0 2xl:flex-1 sm:pr-8">
                <form
                  action=""
                  className="bg-white shadow rounded 2xl:p-20 p-10 sm:pr-8 lg:pr-8 mt-5"
