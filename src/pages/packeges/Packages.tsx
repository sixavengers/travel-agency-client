  ...
  return (
    <div className="my-5 px-3 container mx-auto">
      ...
      <section className="py-5">
        <form
          action=""
          className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5"
        >
          <div className="">
            ...
            <input
              ...
              id=""
              placeholder="Origin"
              className="outline-none border border-gray-400 py-2 px-3 rounded-full shadow-md w-full sm:max-w-xs lg:max-w-full font-poppins"
            />
          </div>
          <div className="relative">
            <span className="hidden sm:block absolute border border-gray-300 top-7 sm:left-[-35px] md:left-[-27px] bg-white z-20 cursor-pointer p-2 rounded-full ">
              <AiOutlineSwap />
            </span>
          ...
          <div className="">
            <p className="font-semibold text-center font-poppins">Price</p>
            <input
              type="text"
              name="price"
              id=""
              placeholder="Price"
              className="outline-none border border-gray-400 py-2 px-3 rounded-full shadow-md w-full sm:max-w-xs lg:max-w-full"
            />
          </div>
          {/* <div className=''>
          ...
          <div className="">
            <input
              ...
              name="returnDate"
              id=""
              className="outline-none border border-gray-400 py-2 px-3 rounded-full shadow-md mt-6 bg-[#1e88e5] text-white font-semibold cursor-pointer w-full sm:max-w-xs font-poppins"
            />
          </div>
        </form>
      </section>
