                ...
                <div className='mt-3 border border-gray-200 bg-white rounded-lg shadow-lg max-w-xs xl:max-w-full h-[535px] overflow-y-auto xl:h-auto xl:flex items-center justify-between mx-auto'>
                    <div className='p-3 xl:flex'>
                        ...
                        <div className='lg:ml-3'>
                            ...
                            <p className='font-poppins mt-2 bg-[#1e88e5]/90 inline-block text-white px-2 rounded-full'>Available Tickets: 16</p>
                ...
                <div className='mt-3 border border-gray-200 bg-white rounded-lg shadow-lg max-w-xs xl:max-w-full h-[535px] overflow-y-auto xl:h-auto xl:flex items-center justify-between mx-auto'>
                    <div className='p-3 xl:flex'>
                        ...
                        <div className='lg:ml-3'>
                            ...
                            <p className='font-poppins mt-2 bg-[#1e88e5]/90 inline-block text-white px-2 rounded-full'>Available Tickets: 12</p>
                ...
                <div className='mt-3 border border-gray-200 bg-white rounded-lg shadow-lg max-w-xs xl:max-w-full h-[535px] overflow-y-auto xl:h-auto xl:flex items-center justify-between mx-auto'>
                    <div className='p-3 xl:flex'>
                        ...
                        <div className='lg:ml-3'>
                            ...
                            <p className='font-poppins mt-2 bg-[#1e88e5]/90 inline-block text-white px-2 rounded-full'>Available Tickets: 5</p>
                ...
                <div className='mt-3 border border-gray-200 bg-white rounded-lg shadow-lg max-w-xs xl:max-w-full h-[535px] overflow-y-auto xl:h-auto xl:flex items-center justify-between mx-auto'>
                    <div className='p-3 xl:flex'>
                        ...
                        <div className='lg:ml-3'>
                            ...
                            <p className='font-poppins mt-2 bg-[#1e88e5]/90 inline-block text-white px-2 rounded-full'>Available Tickets: 46</p>
