import { BiSend, BiTrashAlt } from "react-icons/bi";
...
const ApprovedRow = (props: Props) => {
  return (
    <tr>
      ...
      <td className="border-0 border-b px-4 py-2">
        <div className="flex items-center gap-2">
          <button className="bg-green-100 text-green-500 p-2 flex items-center  capitalize gap-2">
            <BiSend /> Send to pending
          </button>
          <button className="bg-red-100 text-red-500 flex items-center gap-1 p-2 rounded capitalize">
            <BiTrashAlt /> Blocked
          </button>
        </div>
      </td>
